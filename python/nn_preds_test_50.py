...
pred_2 = model.predict(data_test.values)
...
pred_3 = model.predict(data_test.values)
...
pred_4 = model.predict(data_test.values)
...
pred_5 = model.predict(data_test.values)
...
pred_6 = model.predict(data_test.values)
...
pred_7 = model.predict(data_test.values)
...
df.to_csv('nn_preds_test_50epochs.csv', index=False)
