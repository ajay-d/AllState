...
df['xtra_pred_1'] = etr_1.predict(data_test)
df['xtra_pred_2'] = etr_2.predict(data_test)
df['xtra_pred_3'] = etr_3.predict(data_test)
df['reg_pred_1'] = reg_1.predict(data_test)
df['boost_pred_1'] = boost_1.predict(data_test)
df['boost_etr_pred_1'] = boost_etr_1.predict(data_test)
df['boost_etr_pred_2'] = boost_etr_2.predict(data_test)
df['boost_etr_pred_3'] = boost_etr_3.predict(data_test)
df['boost_etr_pred_4'] = boost_etr_4.predict(data_test)
df['boost_etr_pred_5'] = boost_etr_5.predict(data_test)
df['boost_etr_pred_6'] = boost_etr_6.predict(data_test)
df['rf_pred_1'] = rf_1.predict(data_test)
df['rf_pred_2'] = rf_2.predict(data_test)
df['rf_pred_3'] = rf_3.predict(data_test)
df['rf_pred_4'] = rf_4.predict(data_test)
df['boost_rf_pred_1'] = boost_rf_1.predict(data_test)
df['boost_rf_pred_2'] = boost_rf_2.predict(data_test)
df['boost_rf_pred_3'] = boost_rf_3.predict(data_test)
df['boost_rf_pred_4'] = boost_rf_4.predict(data_test)

df.to_csv('trees_preds_test.csv', index=False)